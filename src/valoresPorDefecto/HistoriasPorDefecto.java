...
public class HistoriasPorDefecto {
    public static void poblar() {
        ...
        Paciente alumno = new Paciente("12345678", "Juan", "Pérez", "M", "01/01/2000", "Lima", "Chimbote", "Ancash", "Escuela Primaria", 987654321, "Soltero",  new Familiar("Pedro", "Padre", "Los Héroes", "987654321", ""));
